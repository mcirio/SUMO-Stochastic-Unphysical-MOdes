...
pickle_in = open("./PM_3/Tests/Data/Test_PM_model_BrownianFiniteT.dat",'rb')
...
#fig2.text(.135, .92, r'$(a)$', fontsize=30)
...
fig2.savefig(os.path.join(fig_dir, 'brownian_finiteT.pdf'))  
# fig2.savefig(os.path.join(fig_dir, 'PM_model_Brownian_zeroT_dynamics.svg'))  
# fig3.savefig(os.path.join(fig_dir, 'PM_model_Brownian_zeroT_spectralDensity.svg'))  
