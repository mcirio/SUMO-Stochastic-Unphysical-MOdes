...
"""
This module is used to define the correlations of various baths, either via
Matsubara/Pade decompositions or fitting
"""
...
class matsubara_2():
    """
    Constructs the Matsubara terms for the underdamped brownian motion SD
